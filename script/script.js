...
const boardRegions = document.querySelectorAll('#keys button')
let vBoard = []
let turnPlayer = ''
...
function handleWin(areas) {
  areas.forEach(function (areas) {
    document.querySelector('[data-area="' + areas + '"]').classList.remove('areaBtn')
    document.querySelector('[data-area="' + areas + '"]').classList.add('win')
  })
...
function handleBoardClick(ev) {
  ...
  const region = button.dataset.area // N.N
